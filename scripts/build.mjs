...
function shell({title,subtitle='',eyebrow='STARLIGHT FAIRIES · DEVELOPMENT WIKI',page='index.html',content,toc=[],prefix='',character=false}) {
  return `<!doctype html>
<html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="${escape(title)} — 스타라이트 페어리즈 내부 개발용 위키. 원작소설 1~5권 설정과 ADV·3D 전투 제작 자료."><meta name="robots" content="noindex,nofollow"><meta name="theme-color" content="#ab2867"><title>${escape(title)} | 스타라이트 페어리즈 개발 위키</title><link rel="icon" href="${prefix}sources/branding/StarlightFairiesLogo.png"><link rel="stylesheet" href="${prefix}assets/style.css">${page==='characters.html'&&!character?`<script defer src="${prefix}assets/search-index.js"></script>`:''}<script defer src="${prefix}assets/app.js"></script></head>
